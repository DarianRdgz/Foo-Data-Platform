...
public class KrogerLocationIngestionService {
    ...
    public KrogerLocationIngestionService(KrogerApiClient krogerApiClient, StoreLocationRepository repository, com.fooholdings.fdp.core.ingestion.IngestionRunService runService) {
