...
import com.fooholdings.fdp.grocery.price.PriceObservationEntity;
import com.fooholdings.fdp.grocery.price.PriceObservationRepository;
import com.fooholdings.fdp.grocery.product.ProductCatalogEntity;
import com.fooholdings.fdp.grocery.product.ProductCatalogRepository;
...
public class KrogerProductIngestionService {
    ...
    public KrogerProductIngestionService(KrogerApiClient krogerApiClient,
